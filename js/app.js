...
const birthdays = [
    // ENERO
    { month: 0, day: 1, date: "1 de Enero", name: "Maxi Sobarzo", type: "M-N", message: "🎈 ¡Feliz cumpleaños, Maxi! Que el Señor te bendiga mucho en este día especial. Es una alegría verte crecer en nuestra congregación. ¡Un abrazo grande de parte de toda la iglesia!\n\n📖 *\"Instruye al niño en su camino, Y aun cuando fuere viejo no se apartará de él.\"* - Proverbios 22:6 (RVR1960)" },
    { month: 0, day: 1, date: "1 de Enero", name: "Matías", type: "M-N", message: "🎈 ¡Feliz cumpleaños, Matías! Que el Señor te bendiga muchísimo hoy. Oramos para que Dios guíe siempre tus pasos. ¡Un abrazo grande!\n\n📖 *\"No tengo yo mayor gozo que este, el oír que mis hijos andan en la verdad.\"* - 3 Juan 1:4 (RVR1960)" },
    { month: 0, day: 1, date: "1 de Enero", name: "Sofía", type: "F-N", message: "🎈 ¡Feliz cumpleaños, Sofía! Que tengas un día hermoso. Le pedimos a Dios que te cuide, te proteja y te llene de alegría. ¡Te queremos mucho!\n\n📖 *\"Te alabaré; porque formidables, maravillosas son tus obras; Estoy maravillado, Y mi alma lo sabe muy bien.\"* - Salmos 139:14 (RVR1960)" },
    ...
    // ABRIL
    { month: 3, day: 28, date: "28 de Abril", name: "Hna. Rosa Rumualda Sandalla", type: "F-A", message: "🌸 ¡Feliz cumpleaños, hermana Rosa! Damos gracias a Dios por su vida y su fidelidad. Que tenga un día lleno del amor de los suyos y del cuidado celestial.\n\n📖 *\"Porque yo sé los pensamientos que tengo acerca de vosotros, dice Jehová, pensamientos de paz, y no de mal, para daros el fin que esperáis.\"* - Jeremías 29:11 (RVR1960)" },
    ...
    { month: 4, day: 19, date: "19 de Mayo", name: "Hno. Arnoldo Rivera", type: "M-A", message: "🎂 ¡Feliz cumpleaños, hermano Arnoldo! Le enviamos un afectuoso saludo. Que Dios bendiga su salir y su entrar, y le guarde en todos sus caminos.\n\n📖 *\"Jehová guardará tu salida y tu entrada Desde ahora y para siempre.\"* - Salmos 121:8 (RVR1960)" },

    // JUNIO
    { month: 5, day: 3, date: "3 de Junio", name: "Hno. Alfredo Martínez", type: "M-A", message: "🌟 ¡Feliz cumpleaños, amado hermano Alfredo! Es un privilegio celebrar su vida. Damos gloria a Dios por sus años y por ser una columna en nuestra congregación.\n\n📖 *\"Corona de honra es la vejez Que se halla en el camino de justicia.\"* - Proverbios 16:31 (RVR1960)" },
    ...
    { month: 8, day: 17, date: "17 de Septiembre", name: "Pastora Rossi Shela Soto", type: "F-A", message: "🌸 ¡Muy feliz cumpleaños, Pastora Rossi! Bendecimos su vida, su familia y su ministerio. Damos gracias a Dios por su dedicación y amor hacia la congregación.\n\n📖 *\"Jehová te bendiga, y te guarde; Jehová haga resplandecer su rostro sobre ti, y tenga de ti misericordia; Jehová alce sobre ti su rostro, y ponga en ti paz.\"* - Números 6:24-26 (RVR1960)" },
